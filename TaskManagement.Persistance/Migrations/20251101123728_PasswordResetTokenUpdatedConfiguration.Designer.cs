...
namespace TaskManagement.Persistance.Migrations
{
    ...
    [Migration("20251101123728_PasswordResetTokenUpdatedConfiguration")]
    partial class PasswordResetTokenUpdatedConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.TaskReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.AppUser", b =>
                {
                    b.HasOne("TaskManagement.Domain.Entities.AppRole", "Role")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.TaskReport", b =>
                {
                    b.HasOne("TaskManagement.Domain.Entities.AppTask", "AppTask")
